...
_SleepBag = createVehicle [ "Land_Sleeping_bag_blue_F", _pos, [], 0, "NONE" ];

_SleepBag attachTo [_cutter, [0,0,0.05]];

player removeItem "sc_bedroll";

_SleepBag addAction ["Sleep for 8 hours", {_date = date; _date set [3, (_date select 3) + 8]; setDate _date;}, [], 0, false, true, "", ""];
