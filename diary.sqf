dingus_fnc_createDiary = {
  ...
  _researchFilePatterson = _unit createDiaryRecord ["research", ["Patterson / Gimlin Encounter", "
    ...
    shock after first seeing the figure.
    <br/><br/>
    ...
    The figure in the Patterson–Gimlin film generally matches the descriptions of Bigfoot offered by others who claim to have seen one.
    <br/><br/>
    ...
    in hand, he dismounted, but did not point his rifle at the creature.
    <br/><br/>
    ...
    creature's expression as one of ""contempt and disgust...you know how it is when the umpire tells you 'one more word and you're out of the game.' That's the way it felt.""
    <br/><br/>
    ...
    after Patterson moved ten feet to a better vantage point, fading into the trees again and being lost to view at a distance of 265 feet as the reel of film ran out.
    <br/><br/>
    ...
    because he feared the creature's mate might approach. The entire encounter had lasted less than two minutes.
    <br/><br/>
    ...
    step-length, and made two plaster casts, one each of the best-quality right and left prints.
    <br/><br/>
    <br/><br/>
